...
export class RichToolbar extends LitElement {
  ...
  render() {
    ...
    return html`<header>
      ...
      ></rich-action>
      <rich-action icon="align_left" command="justifyleft"></rich-action>
      <rich-action icon="align_center" command="justifycenter"></rich-action>
      <rich-action icon="align_right" command="justifyright"></rich-action>
      <rich-action
        icon="list_numbered"
      ...
      <rich-action
        ...
        value="blockquote"
      ></rich-action>
      <rich-action icon="indent_decrease" command="outdent"></rich-action>
      <rich-action icon="indent_increase" command="indent"></rich-action>
      <rich-action
        icon="add_link"
      ...
      <rich-action icon="color_text" @action=${() => this.fgColorInput.click()}>
        <input
          type="color"
          id="fg-color"
          @input=${(e: Event) => {
